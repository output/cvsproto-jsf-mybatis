 ...
 *  DB アクセス用 DAO クラス。
 */
public class SZAB011CSelectDAO
        extends java.lang.Object implements com.jp.systemdirector.projectzero.zab01.db.dao.ISZAB011CSelectDAO {
    ...
    public List<SZAB011CSelectDTO> selectStoringId(SZAB011CSelectDTO dto) throws java.sql.SQLException {
        SZAB011CSelectDAOSelectStoringId dao = new SZAB011CSelectDAOSelectStoringId();
        List<SZAB011CSelectDTO> ret = dao.execute(dto);
        return ret;
    }
    ...
    public List<SZAB011CSelectDTO> findById(SZAB011CSelectDTO dto) throws java.sql.SQLException {
        SZAB011CSelectDAOFindById dao = new SZAB011CSelectDAOFindById();
        List<SZAB011CSelectDTO> ret = dao.execute(dto);
        return ret;
    }
}
